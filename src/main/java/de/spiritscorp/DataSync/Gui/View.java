...
public class View extends JFrame {
	...
	private final Controller event;
	private StringBuffer sb_textArea;
	private final Font font = new Font("Comic Sans MS", 1, 14);
	private final Color fgColor = Color.decode("#FFFF00");
	...
	private void initComponents(ArrayList<Path> sourcePath, String destPath, Preference pref) {
		...
		*/
		...
		if (pref.isBgSync())
			autoDelCheck.setSelected(pref.isAutoBgDel());
		else
		...
		bgTimeComboBox = new JComboBox<>();
		bgTimeComboBox.setModel(new DefaultComboBoxModel<>(BgTime.getNames()));
	...
	public JButton getPreference() { return preference; }

	public JLabel getDestLabel() { return destLabel; }

	public JTextArea getSourceLabel() { return sourceLabel; }

	public JCheckBox getLogOnBox() { return logOnBox; }

	public JComboBox<String> getScanModeComboBox() { return deepScanComboBox; }

	public JCheckBox getAutoDelCheck() { return autoDelCheck; }

	public JCheckBox getPlatzhalter() { return platzhalter; }

	public JCheckBox getAutoSyncCheck() { return autoSyncCheck; }

	public JCheckBox getBgSyncCheck() { return bgSyncCheck; }

	public JCheckBox getTrashbinCheck() { return trashbinCheck; }

	public JComboBox<String> getBgTimeComboBox() { return bgTimeComboBox; }
}
